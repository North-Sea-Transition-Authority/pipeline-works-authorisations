...
public class BeanConfig {
  ...
  public FilterRegistrationBean<FoxSessionFilter> foxSessionFilterRegistration(FoxSessionFilter foxSessionFilter) {
    ...
    // If auto registration is not disabled, Spring will includes the session filter 'early' in its filter chain as part of Spring Session
    // filters but before Spring Security. This causes the FoxSessionFilter to be included in requests that have disabled Spring Security (e.g. /assets/**)
