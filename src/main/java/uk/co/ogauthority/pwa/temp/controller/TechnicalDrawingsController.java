...
public class TechnicalDrawingsController {
  ...
  @Autowired
  public TechnicalDrawingsController(PipelineGodObject pipelineGodObject, TechnicalDrawingsGodObject technicalDrawingsGodObject) {
    ...
    technicalDrawingsGodObject.setTechnicalDrawingViews(List.of(
        new TechnicalDrawingView(1, "/assets/temp/images/technical_drawing_ex1.png", List.of()),
  ...
  public ModelAndView viewDrawingEdit(@PathVariable("applicationId") Integer applicationId,
    ...
    return new ModelAndView("pwaApplication/temporary/technicalDrawings/links")
