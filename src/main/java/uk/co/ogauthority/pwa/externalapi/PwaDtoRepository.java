...
@Repository
interface PwaDtoRepository extends PagingAndSortingRepository<MasterPwaDetail, Integer> {
  ...
  List<PwaDto> searchPwas(List<Integer> ids, String reference, MasterPwaDetailStatus status, Pageable pageable);
}
