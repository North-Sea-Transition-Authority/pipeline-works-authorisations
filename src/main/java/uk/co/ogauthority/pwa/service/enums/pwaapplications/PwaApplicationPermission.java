...
public enum PwaApplicationPermission {
  ...
  SET_PIPELINE_REFERENCE(
      EnumSet.noneOf(PwaContactRole.class),
      EnumSet.noneOf(PwaOrganisationRole.class),
      EnumSet.noneOf(PwaRegulatorRole.class),
      EnumSet.noneOf(ConsulteeGroupMemberRole.class),
      userRolesForApplicationDto ->
  ...
  /**
   * Not designed to be to have both an override function and individual roles specified during construction.
   * User alterantive constructors that determine defaults values for you.
   */
