...
public enum DocumentTemplateMnem {
  ...
  PETROLEUM_CONSENT_DOCUMENT(Set.of(
      ...
      DocumentSpec.PIPELINE_RECORD_MANAGEMENT_PETROLEUM_CONSENT_DOCUMENT)
  ),
  ...
  HYDROGEN_CONSENT_DOCUMENT(Set.of(
      ...
      DocumentSpec.PIPELINE_RECORD_MANAGEMENT_HYDROGEN_CONSENT_DOCUMENT)
  ),
  CCUS_CONSENT_DOCUMENT(Set.of(
      ...
      DocumentSpec.PIPELINE_RECORD_MANAGEMENT_CCUS_CONSENT_DOCUMENT)
  );
