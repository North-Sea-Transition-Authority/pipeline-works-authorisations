...
public class BlockCrossingDocumentsController extends PwaApplicationDataFileUploadAndDownloadController {
  ...
  public ModelAndView renderEditBlockCrossingDocuments(
    ...
    applicationBreadcrumbService.fromCrossings(applicationContext.getPwaApplication(), modelAndView,
  ...
  public ModelAndView postBlockCrossingDocuments(
      @PathVariable("applicationType") @ApplicationTypeUrl PwaApplicationType applicationType,
      @PathVariable("applicationId") Integer applicationId,
      //TODO once PWA-366 merged then do conditional mandatory document validation
      @Validated({PartialValidation.class}) @ModelAttribute("form") BlockCrossingDocumentsForm form,
  ...
  private ModelAndView createBlockCrossingModelAndView(PwaApplicationDetail pwaApplicationDetail,
    ...
    modelAndView.addObject("crossingUrl", ReverseRouter.route(on(CrossingAgreementsController.class)
