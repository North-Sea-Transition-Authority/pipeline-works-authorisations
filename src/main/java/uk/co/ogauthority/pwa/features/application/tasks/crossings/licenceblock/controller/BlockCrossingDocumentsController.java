...
public class BlockCrossingDocumentsController {

  private static final FileDocumentType DOCUMENT_TYPE = FileDocumentType.BLOCK_CROSSINGS;
  ...
  public ModelAndView renderEditBlockCrossingDocuments(
    ...
    return createBlockCrossingModelAndView(pwaApplicationDetail, form);
  }
  ...
  private ModelAndView createBlockCrossingModelAndView(PwaApplicationDetail pwaApplicationDetail,
    ...
    var modelAndView = new ModelAndView("pwaApplication/form/uploadFiles")
        .addObject("pageTitle", "Block crossing agreement documents")
