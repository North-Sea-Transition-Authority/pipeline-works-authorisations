...
public class MedianLineDocumentsController {

  private static final FileDocumentType DOCUMENT_TYPE = FileDocumentType.MEDIAN_LINE_CROSSING;
  ...
  private ModelAndView createMedianLineCrossingModelAndView(PwaApplicationDetail pwaApplicationDetail,
    ...
    var modelAndView = new ModelAndView("pwaApplication/form/uploadFiles").addObject("pageTitle", "Median line agreement documents")
  ...
  public ModelAndView renderEditMedianLineCrossingDocuments(
    ...
    return createMedianLineCrossingModelAndView(pwaApplicationDetail, form);
  }
