...
public class PipelineCrossingDocumentsController {

  private static final FileDocumentType DOCUMENT_TYPE = FileDocumentType.PIPELINE_CROSSINGS;
  ...
  private ModelAndView createPipelineCrossingModelAndView(PwaApplicationDetail pwaApplicationDetail,
    ...
    var modelAndView = new ModelAndView("pwaApplication/form/uploadFiles")
        .addObject("pageTitle", "Pipeline crossing agreement documents")
  ...
  public ModelAndView renderEditPipelineCrossingDocuments(
    ...
    return createPipelineCrossingModelAndView(pwaApplicationDetail, form);
  }
