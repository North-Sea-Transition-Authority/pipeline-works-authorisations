...
public enum PwaAppProcessingPermission {
  ...
  SHOW_ALL_TASKS_AS_PWA_MANAGER_ONLY(ProcessingPermissionType.GENERIC),

  // PUBLIC NOTICE
  VIEW_ALL_PUBLIC_NOTICES,
  VIEW_PUBLIC_NOTICE,
  OGA_EDIT_PUBLIC_NOTICE,
  DRAFT_PUBLIC_NOTICE,
  ...
  UPDATE_APPLICATION,
  PAY_FOR_APPLICATION,
  VIEW_PAYMENT_DETAILS_IF_EXISTS,
  MANAGE_APPLICATION_CONTACTS,

  //SECONDARY_REGULATOR
  CASE_MANAGEMENT_SECONDARY_REGULATOR,
