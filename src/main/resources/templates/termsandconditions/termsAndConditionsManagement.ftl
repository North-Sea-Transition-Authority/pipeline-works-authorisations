...
<@defaultPage htmlTitle="Terms and conditions" pageHeading="Terms and conditions" pageHeadingClass="govuk-heading-xl govuk-!-margin-bottom-2" fullWidthColumn=false wrapperWidth=true>
