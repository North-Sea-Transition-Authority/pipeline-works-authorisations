...
<div class="pwa-application-summary-section">
  <h2 class="govuk-heading-l" id="projectExtensionDetails">${sectionDisplayText}</h2>
  <@fdsCheckAnswers.checkAnswers>
    <@fdsCheckAnswers.checkAnswersRow keyText="Project extension permission" actionUrl="" screenReaderActionText="" actionText="">
      ...
      <#else>
        No Consents and Authorisations Manager (CAM) approval has been added to this application.
      </#if>
