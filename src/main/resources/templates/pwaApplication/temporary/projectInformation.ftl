...
<@defaultPage htmlTitle="Project Information" pageHeading="Project information" twoThirdsColumn=true>
    <@fdsForm.htmlForm actionUrl="" useMethod="">
        ...
        <@fdsDateInput.dateInput dayPath="form.earliestCompletionDay" monthPath="form.earliestCompletionMonth" yearPath="form.earliestCompletionYear" formId="1" labelText="Earliest completion date" defaultHint=false fieldsetHeadingSize="h2" fieldsetHeadingClass="govuk-fieldset__legend--l"/>
        <@fdsDateInput.dateInput dayPath="form.latestCompletionDay" monthPath="form.latestCompletionMonth" yearPath="form.latestCompletionYear" formId="1" labelText="Latest completion date" defaultHint=false fieldsetHeadingSize="h2" fieldsetHeadingClass="govuk-fieldset__legend--l"/>
