    ...
    <#list workScheduleViewList as workSchedule>
        <@fdsCard.card>
            <@fdsDataItems.dataItem>
                <@fdsDataItems.dataValues key="Work starts" value=workSchedule.getFormattedWorkStartDate()/>
                <@fdsDataItems.dataValues key="Work ends" value=workSchedule.getFormattedWorkEndDate()/>
            </@fdsDataItems.dataItem>
