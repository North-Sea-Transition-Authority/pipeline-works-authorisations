...
<@defaultPage htmlTitle="Edit cable crossing" pageHeading="Edit cable crossing" breadcrumbs=true>
    ...
    <@fdsForm.htmlForm>
        ...
        <@fdsAction.submitButtons linkSecondaryAction=true primaryButtonText="Save cable crossing" secondaryLinkText="Back to pipeline crossings" linkSecondaryActionUrl=springUrl(backUrl)/>
    </@fdsForm.htmlForm>
</@defaultPage>