...
<@defaultPage htmlTitle="Crossing agreements" pageHeading="Crossing agreements" breadcrumbs=true>
  <h2 class="govuk-heading-l">Median line agreement</h2>
    <#if medianLineCrossing?has_content>
        <@fdsAction.link linkText="Update median line agreement" linkUrl=springUrl("#") role=true linkClass="govuk-button govuk-button--blue"/>
    ...
    <#else>
        ...
        <@fdsAction.link linkText="Provide median line agreement information" linkUrl=springUrl("#") role=true linkClass="govuk-button govuk-button--blue"/>
    </#if>
</@defaultPage>