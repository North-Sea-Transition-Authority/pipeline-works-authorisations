...
<@defaultPage htmlTitle="Add user to ${groupName}" backLink=true topNavigation=showTopNav twoThirdsColumn=true>
    <@fdsForm.htmlForm>
        ...
        detailsText="A user must have an account on the Energy Portal before you can add them to your organisation. A user can register for an account on the Energy Portal at [registration link]."/>
