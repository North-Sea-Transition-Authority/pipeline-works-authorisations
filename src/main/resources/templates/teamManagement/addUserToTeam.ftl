...
<#-- @ftlvariable name="registrationUrl" type="String" -->
...
<@defaultPage htmlTitle="Add user to ${groupName}" backLink=true topNavigation=showTopNav>
    <@fdsForm.htmlForm>
        ...
        <@fdsDetails.summaryDetails summaryTitle="The user I want to add does not have an account">
            A user must have an account on the Energy Portal before you can add them to your organisation. A user can register for an account on the UK Energy Portal at
            <@fdsAction.link linkText=registrationUrl! linkUrl=registrationUrl!/>
