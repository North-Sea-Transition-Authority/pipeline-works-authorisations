<#-- @ftlvariable name="headerUrl" type="java.lang.String" -->

<#import '/spring.ftl' as spring>
<#import 'button.ftl' as govukAction>
...
<#--GOVUK Header-->
<#macro header headerNavClass=false currentUserView="">
<header class="govuk-header <#if headerNavClass>govuk-header--navigation-menu</#if>" role="banner" data-module="header">
  <div class="govuk-header__container govuk-width-container">

    <div class="govuk-header__logo">
      <a href="https://www.gov.uk/government/organisations/marine-management-organisation" class="govuk-header__link govuk-header__link--homepage">
        <span class="govuk-header__logotype">
          <svg role="presentation" focusable="false" class="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 132 97" height="40px" width="47px">
            ...
            <image src="${springUrl("/assets/images/mmo/mmo-logo-white-crest.png")}" class="govuk-header__logotype-crown-fallback-image"></image>
          </svg>
    ...
    <div class="govuk-header__content">
      <a href="<#if headerUrl?has_content><@spring.url headerUrl/><#else>#</#if>" class="govuk-header__link govuk-header__link--service-name">
        Self-service
      </a>
      <button type="button" role="button" class="govuk-header__menu-button js-header-toggle" aria-controls="navigation" aria-label="Show or hide Top Level Navigation" id="expand-contract-menu-button">Menu</button>
      <nav>
            ...
            <#if currentUserView.isAuthenticated()>
              ...
              <li class="govuk-header__navigation-item">
                ...
                <@form.govukForm springUrl('/logout')>
                  <@govukAction.button buttonText="Sign out" buttonClass="govuk-header__link govuk-button--link govuk-button--header-link"/>
                </@form.govukForm>
              </li>
            </#if>
          </#if>
