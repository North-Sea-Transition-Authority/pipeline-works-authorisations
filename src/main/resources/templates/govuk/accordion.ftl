...
<#macro accordion accordionId>
  <#assign accordionCounter = 0>
  <#assign accordionGlobalId = accordionId>
  <div class="govuk-accordion" data-module="accordion" id="${accordionGlobalId}-${accordionCounter}">
    <#nested>
  </div>
</#macro>
  ...
  <div class="govuk-accordion__section ">
    <div class="govuk-accordion__section-header">
      <${sectionHeadingSize} class="govuk-accordion__section-heading">
          <span class="govuk-accordion__section-button" id="${accordionGlobalId}-heading-${accordionCounter}">
            ${sectionHeading}
          </span>
      </${sectionHeadingSize}>
