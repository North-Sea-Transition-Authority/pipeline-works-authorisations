...
errorItems=[]>
    ...
    <#--Navigation-->
    <#if topNavigation>
      <@fdsNavigation.navigation serviceName=service.getServiceAcronym() serviceUrl=springUrl(service.getServiceUrl()) navigationItems=navigationItems currentEndPoint=currentEndPoint wrapperWidth=wrapperWidth />
    </#if>
