CREATE OR REPLACE VIEW ${datasource.user}.application_detail_view (
  pwa_id
, pwa_detail_id
, pwa_application_id
...
LEFT JOIN ${datasource.user}.public_notices pn ON pn.application_id = pa.id AND pn.status NOT IN ('WITHDRAWN')
