...
JOIN ${datasource.user}.vw_pwa_holder_org_grps phog ON phog.pwa_id = pd.pwa_id
JOIN ${datasource.user}.portal_organisation_groups pog ON pog.org_grp_id = phog.org_grp_id
