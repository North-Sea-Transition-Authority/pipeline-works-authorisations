...
public class BlockCrossingFileServiceTest {
  ...
  @Test
  public void validate_partial_whenDocumentDescriptionOverMaxCharLength_invalid() {
  ...
  @Test
  public void validate_full_whenDocumentDescriptionOverMaxCharLength_invalid() {
    FileUploadTestUtil.addUploadFileWithDescriptionOverMaxCharsToForm(form);
    var bindingResult = new BeanPropertyBindingResult(form, "form");
    blockCrossingFileService.validate(form, bindingResult, ValidationType.FULL, pwaApplicationDetail);
