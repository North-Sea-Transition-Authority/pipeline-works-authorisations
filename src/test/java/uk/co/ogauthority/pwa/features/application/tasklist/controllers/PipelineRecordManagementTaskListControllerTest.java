...
@WebMvcTest(controllers = PipelineRecordManagementTaskListController.class, includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = PwaApplicationContextService.class))
@ActiveProfiles(Profile.ENABLE_PRUAT_ENHANCEMENTS)
class PipelineRecordManagementTaskListControllerTest extends TaskListControllerTest {
  ...
  void setUp() {
    ...
    detail = PwaApplicationTestUtil.createDefaultApplicationDetail(PwaApplicationType.PIPELINE_RECORD_MANAGEMENT);
    ...
    endpointTester = new PwaApplicationEndpointTestBuilder(mockMvc, pwaApplicationPermissionService, pwaApplicationDetailService)
        .setAllowedTypes(PwaApplicationType.PIPELINE_RECORD_MANAGEMENT)
  ...
  void viewTaskList_appTypeSmokeTest() {
    endpointTester.setRequestMethod(HttpMethod.GET)
        .setEndpointUrlProducer((applicationDetail, type) ->
            ReverseRouter.route(on(PipelineRecordManagementTaskListController.class)
                .viewTaskList(
