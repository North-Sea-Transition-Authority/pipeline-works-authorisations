...
@WebMvcTest(
    controllers = LocationDetailsDocumentsController.class,
    includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = PwaApplicationContextService.class)
)
public class LocationDetailsDocumentsControllerTest extends PwaApplicationContextAbstractControllerTest {
