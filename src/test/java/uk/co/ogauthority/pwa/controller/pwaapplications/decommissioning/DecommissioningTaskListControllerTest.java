...
@WebMvcTest(controllers = DecommissioningTaskListController.class)
public class DecommissioningTaskListControllerTest extends AbstractControllerTest {
  ...
  public void setUp() {
    ...
    pwaApplication = new PwaApplication(masterPwa, PwaApplicationType.DECOMMISSIONING, 0);
  ...
  public void viewTaskList_Authenticated() throws Exception {
    ...
    var modelAndView = mockMvc.perform(get(
        ReverseRouter.route(on(DecommissioningTaskListController.class).viewTaskList(1, null)))
  ...
  public void viewTaskList_Unauthenticated() throws Exception {
    mockMvc.perform(get(ReverseRouter.route(on(DecommissioningTaskListController.class).viewTaskList(1, null))))
        .andExpect(status().is3xxRedirection());
  }

  @Test
  public void viewTaskList_WrongApplicationType() throws Exception {
    var incorrectApplicationTypes = getIncorrectApplicationTypes(PwaApplicationType.DECOMMISSIONING);
