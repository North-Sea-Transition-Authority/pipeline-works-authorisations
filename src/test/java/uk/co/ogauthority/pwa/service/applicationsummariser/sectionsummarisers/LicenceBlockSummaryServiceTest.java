...
public class LicenceBlockSummaryServiceTest {
  ...
  public void summariseSection_verifyServiceInteractions() {
    ...
    assertThat(appSummary.getTemplateModel()).contains(entry("sectionDisplayText", ApplicationTask.CROSSING_AGREEMENTS.getDisplayName()));
    ...
    assertThat(appSummary.getSidebarSectionLinks()).containsExactly(
        SidebarSectionLink.createAnchorLink(ApplicationTask.CROSSING_AGREEMENTS.getDisplayName(), "#licenceBlockDetails")
    );
